...
def home(request):
    if request.session.has_key('uid'):
        ...
        if request.user.is_staff:
            ...
            stu_files =  userr.files_set.all()
        context = {'subjects':subjects,'students':students,'enrolls':enrolls,'total_courses':total_courses,'total_students':total_students,'active':active,'total_enrolls':total_enrolls,'userr':userr,'stu_files':stu_files}
